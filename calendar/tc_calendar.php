...
class tc_calendar_{
	...
	function getDayHeaders(){
		if($this->startMonday)
			return array("1"=>"Se", "2"=>"Te", "3"=>"Qu", "4"=>"Qu", "5"=>"Se", "6"=>"Sa","7"=>"Do");
		else
			return array("7"=>"Do", "1"=>"Se", "2"=>"Te", "3"=>"Qu", "4"=>"Qu", "5"=>"Se", "6"=>"Sa");
	}
	...
	function getMonthNames(){
		return array("Janeiro", "Fevereiro", "Mar&ccedil;o", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro");		
	}
