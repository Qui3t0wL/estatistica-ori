...
?>
    ...
    <table id="prova">
        <tr>
            <td style="text-align:right"><b>Prova: </b></td><td><?php $r = mysqli_fetch_assoc($dados_prova); echo utf8_encode($r['event_name']);?></td> 			
        ...
        <tr>
            <td style="text-align:right"><b>Organiza&ccedil;&atilde;o: </b></td><td><?php echo utf8_encode($r['cl']);?></td>
