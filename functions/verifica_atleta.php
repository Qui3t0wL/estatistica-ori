 ...
 * 
 * Esta funчуo verifica se fiz a prova e faz update a tabela.
 ...
 * @copyright Junho 2012
 * 
 * Esta funчуo copia dados para um ficheiro txt.
 * 
 */
...
function copia_dados_ficheiro($prova){
	...
	while (($data = fgetcsv($handler, 1000, ";")) !== FALSE) {
		...
		if($data[18] == $escalao1['class_desc']){
            ...
            if ($data[12] == 0){ //se nуo tiver mp
                if ($data[8] == "0"){ //se nуo tiver nc
                    //faz o insert normal
 ...
 * @copyright Junho 2012
 * 
 * Esta funчуo atualiza os pontos na prova em questуo.
 * 
 */
